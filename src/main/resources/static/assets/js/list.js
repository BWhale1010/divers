...
function listDraw(list){
	...
	list.forEach(function(item){
	   ...
	   if(item.content == ""){
		   ...
		   '<span>'+item.board_date+'</span></div><h3><a href="/board/detail/'+item.post_num+'">'+item.title+'</a></h3><p>(그림만 작성된 글입니다)</p>'+
