                ...
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-1.jpg');">
                    <div class="img-bg-inner">
                      <h2>1. 추천글 제목 추천글 제목추천글 제목추천글 제목추천글 제목추천글 제목추천글 제목추천글 제목</h2>
                      <p>추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 추천글 내용 </p>
                    </div>
                  </a>
                </div>
                  ...
                  <ul class="trending-post">
                    <li>
                      <a href="single-post.html">
                        ...
                        <h3>최신글 1번 쓸거임 최신글 1번 쓸거임 최신글 1번 쓸거임 최신글 1번 쓸거임</h3>
