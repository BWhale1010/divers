  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="/" class="logo d-flex align-items-center">
        ...
        <img src="/assets/img/divers.png"  style="width: 100px; height: auto;">
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          					<li class="dropdown"><a href="#"><span>자유게시판</span> <i
						...
						<ul>
							...
							<li><a href="#">공지</a></li>
          					...
          					<li class="dropdown"><a href="#"><span>스포츠</span> <i
							class="bi bi-chevron-down dropdown-indicator"></i></a>
						<ul>
							<li class="dropdown"><a href="#"><span>축구</span> <i
									class="bi bi-chevron-down dropdown-indicator"></i></a>
								<ul>
							...
							<li class="dropdown"><a href="#"><span>야구</span> <i
									class="bi bi-chevron-down dropdown-indicator"></i></a>
								<ul>
					...
					<li class="dropdown"><a href="#"><span>커뮤니티</span> <i
						...
						<ul>
							...
							<li class="dropdown"><a href="#"><span>미술</span> <i
									class="bi bi-chevron-down dropdown-indicator"></i></a>
								<ul>
      ...
      <a href="/user/login"><img src="/assets/img/login.png" style="width:25px; margin:0 7px 0 7px;"></a>
      <a href="/user/joinCheck"><img src="/assets/img/join.png" style="width:25px; margin:0 7px 0 7px;"></a>
