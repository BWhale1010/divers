      ...
      <div class="container">
        ...
        <div class="row g-5">
          ...
          <div class="col-6 col-lg-2">
            ...
            <ul class="footer-links list-unstyled">
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 공지</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 유머</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 정보</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 국내축구</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 국내야구</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 국내음악</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 동양미술</a></li>
              <li><a href="category.html"><i class="bi bi-chevron-right"></i> 영화</a></li>
